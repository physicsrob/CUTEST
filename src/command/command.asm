...
PROCESS_COMMAND:	EQU	$	;PROCESS THIS COMMAND LINE
			...
			JZ	ERROR_HANDLER_DE	;NO COMMAND?
...
DISP0:			EQU	$	;HERE TO EITHER DISPATCH OR DO ERROR
			JZ	ERROR_HANDLER_HL	;NOT IN EITHER TABLE
...
STUP:	EQU	$	;PREPARE WHETHER VDM OR NOT
	...
	JMP	VDAD2	;GET SCRN ADDR AND RETURN
...
-:	LDAX	D	;GET CHARACTER
	...
	JNC	ERROR_HANDLER_DE	;NOT VALID HEXIDECIMAL VALUE
	ADD	L
	MOV	L,A	;MOVE IT IN
...
;
ERROR_HANDLER_DE:	\
	XCHG		;GET SCAN ADDRESS
ERROR_HANDLER_HL:	\
	MVI	M,'?'	;FLAG THE ERROR
	IFDEF USEVDM
